 ...
 * @typedef {object} ReturnTesterSample
 * @property {any[]} inputs
 * @property {any} output
 */
 ...
 * @typedef {object} LogTesterSample
 * @property {any[]} inputs
 ...
 * @typedef {"get" | "post" | "put" | "patch" | "delete"} RouteTesterMethods
 */
 ...
 * @property {*} data
 * @property {import("axios").HttpStatusCode} status
 */
 ...
 * 
 * @typedef {object} RouteTest
 * @property {RouteTesterOutput} output
 * @property {object | null} [body]
 * @property {import("axios").AxiosRequestConfig | null} [config]
 * @property {object | null} [params]
 * @property {object | null} [querys]
 */

/**
 * Used to specify whether to override an existing `Tester` that has the same name, if there is one.
 * 
 * @typedef {object} TesterManagerOptions
 * @property {Boolean | null} [override]
 */
...
module.exports = class TesterManager {
     ...
     * @param {ReturnTesterSample} inputOutputSamples an array of sample inputs and output used to test the `function`
     * @param {TesterManagerOptions | undefined | null} options a object that is used to specify if user wants to override an existing `Tester` with the same name in `testers` object
     */
     ...
     * @param {String} description a description of what the tester tests
     * @param {Function} func the function that the tester is testing
     * @param {LogTesterSample} inputOutputSamples an array of sample inputs and output used to test the `function`
     * @param {TesterManagerOptions | undefined | null} options a object that is used to specify if user wants to override an existing `Tester` with the same name in `testers` object
     */
