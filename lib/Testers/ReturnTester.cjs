...
module.exports = class ReturnTester extends FunctionTester {
    ...
    constructor(name, description, func, inputOutputSamples) {
        ...
        validator.checkObjectStructureArray(inputOutputSamples, "inputOutputSamples", {
            inputs: new Array,
            output: "*"
        });
    ...
    setInputOutputSamples(newInputOutputSamples) {
        ...
        validator.checkObjectStructureArray(newInputOutputSamples, "newInputOutputSamples", {
            inputs: new Array,
            output: "*"
        });
